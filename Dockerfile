...
ARG DATABASE_URL="mysql2://mysql@host.docker.internal:3306/app"
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl default-mysql-client libsqlite3-0 libvips postgresql-client nodejs && \
